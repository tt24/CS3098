...
public class RoomDisplay implements MouseListener {

	// temporary, just to show how the line can be selected
	private String text = "Player1\nPlayer2\nPlayer3";
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				RoomDisplay rDisplay = new RoomDisplay();
				rDisplay.createAndShowGUI();
			}
		});
	}
